...
*/
    ...
    public create = async (createData: TCreateDto): Promise<any> => {
        ...
        if (this.attributeBase === 'date') {
            ...
            if (findData.totalItems != 0) {
                const updateData = await this.update(findData.results[0]._id, createData as any)
                return updateData;
            }

        }
        if (this.attributeBase && this.attributeBase !== 'date') {
    ...
    */
    ...
    public async update(dataId: string, updateData: TUpdateDto): Promise<any> {
        ...
        if (updateData[this.attributeBase] && this.attributeBase !== 'date') {
